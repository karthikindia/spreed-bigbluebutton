...
const fetchConversations = async function() {
	const response = await axios.get(generateOcsUrl('apps/talk_bbb/api/v1', 2) + 'room')
	return response
}
...
const fetchConversation = async function(token) {
	const response = await axios.get(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}`)
	return response
}
...
const createOneToOneConversation = async function(userId) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room`, { roomType: CONVERSATION.TYPE.ONE_TO_ONE, invite: userId })
		return response
	} catch (error) {
...
const createGroupConversation = async function(invite, source) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room`, { roomType: CONVERSATION.TYPE.GROUP, invite, source: source || 'groups' })
		return response
	} catch (error) {
...
const createPrivateConversation = async function(conversationName) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room`, { roomType: CONVERSATION.TYPE.GROUP, roomName: conversationName })
		return response
	} catch (error) {
...
const createPublicConversation = async function(conversationName) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room`, { roomType: CONVERSATION.TYPE.PUBLIC, roomName: conversationName })
		return response
	} catch (error) {
...
const setConversationPassword = async function(token, password) {
	const response = await axios.put(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/password`, {
		password,
	})
	return response
}
...
const setConversationName = async function(token, name) {
	const response = await axios.put(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}`, {
		roomName: name,
	})
	return response
}
...
const deleteConversation = async function(token) {
	try {
		const response = await axios.delete(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}`)
		return response
	} catch (error) {
...
const addToFavorites = async function(token) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/favorite`)
		return response
	} catch (error) {
...
const removeFromFavorites = async function(token) {
	try {
		const response = await axios.delete(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/favorite`)
		return response
	} catch (error) {
...
const setNotificationLevel = async function(token, level) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/notify`, { level })
		return response
	} catch (error) {
...
const makePublic = async function(token) {
	try {
		const response = await axios.post(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/public`)
		return response
	} catch (error) {
...
const makePrivate = async function(token) {
	try {
		const response = await axios.delete(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/public`)
		return response
	} catch (error) {
...
const changeLobbyState = async function(token, newState, timestamp) {
	try {
		const response = await axios.put(generateOcsUrl('apps/talk_bbb/api/v1', 2) + `room/${token}/webinar/lobby`, {
			state: newState,
			timer: timestamp,
		})
		return response
